"""
Django settings for foodspots project - PRODUCTION READY
"""
...
WSGI_APPLICATION = 'foodspots.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.contrib.gis.db.backends.postgis',
        'NAME': config('DB_NAME', default='foodspots_db'),
